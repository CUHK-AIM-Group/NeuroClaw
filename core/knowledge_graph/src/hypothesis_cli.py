...
Usage (run from project root):
    ...
    python -m core.knowledge_graph.phase3 imaging-batch --dataset UKB --output core/knowledge_graph/data/hypotheses_imaging_ukb.json
...
def main():
    ...
    p_batch.add_argument("--output", default="core/knowledge_graph/data/hypotheses_baseline.json", help="Output JSON path")
    ...
    p_rank.add_argument("--input", default="core/knowledge_graph/data/hypotheses_baseline.json", help="Input JSON path")
