...
Usage:
    python -m core.knowledge_graph.src.apply_claim_filter_to_kg \
        --graph core/knowledge_graph/data/full/knowledge_graph.json \
        --bad-ids core/knowledge_graph/data/full/bad_claim_ids.json \
        [--dry-run]
"""
