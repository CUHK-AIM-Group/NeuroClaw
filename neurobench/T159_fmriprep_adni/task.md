# T159_fmriprep_adni: fMRIPrep Pipeline: ADNI
## Task Description

Run the full fMRIPrep anatomical + functional workflow for an ADNI subject (longitudinal T1w handling noted if multiple sessions). Produce standard fMRIPrep derivatives and the HTML QC report.
...
- Save all generated artifacts to:
  - benchmark_results/T159_fmriprep_adni/
