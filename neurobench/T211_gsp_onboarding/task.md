# T211_gsp_onboarding: GSP Onboarding: Download, Stage, Validate
## Task Description

Download a subject subset of Brain Genomics Superstruct Project (GSP via the Harvard Dataverse), stage it into a BIDS-compliant directory, and produce a validation + inventory report.
...
- Save all generated artifacts to:
  - benchmark_results/T211_gsp_onboarding/
