# T413_lightgbm_baseline: LightGBM Baseline
## Task Description

Train and evaluate the LightGBM Baseline on vectorized FC features for the standard settings. LightGBM on vectorized FC features.
...
- Use `models/train_unified.py --model lightgbm` for both settings.
...
- Save artefacts under `models/benchmark_results/T413_lightgbm_baseline/<setting>/`.

- Save checkpoints under `models/checkpoints/lightgbm/<atlas>/fold{k}.pt`.
