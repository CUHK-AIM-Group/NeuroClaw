# T340_search_sleep_fmri: Academic Search: Sleep Functional Mri Default Mode
## Task Description

Search for the most recent papers related to **"sleep functional MRI default mode"** from multiple academic platforms (arXiv, PubMed, Semantic Scholar), deduplicate across platforms, and save structured results.
...
- Save all generated artifacts to:
  - benchmark_results/T340_search_sleep_fmri/
