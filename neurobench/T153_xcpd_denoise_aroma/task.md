# T153_xcpd_denoise_aroma: XCP-D Denoising: ICA-AROMA
## Task Description

Post-process fMRIPrep derivatives with XCP-D using the ICA-AROMA non-aggressive denoising + 6 motion parameters strategy. Produce denoised BOLD, confound-filtering QC, and framewise-displacement statistics.
...
- Save all generated artifacts to:
  - benchmark_results/T153_xcpd_denoise_aroma/
