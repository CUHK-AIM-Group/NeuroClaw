# T210_camcan_onboarding: CamCAN Onboarding: Download, Stage, Validate
## Task Description

Download a subject subset of Cam-CAN (Cam-CAN via the Cam-CAN portal), stage it into a BIDS-compliant directory, and produce a validation + inventory report.
...
- Save all generated artifacts to:
  - benchmark_results/T210_camcan_onboarding/
