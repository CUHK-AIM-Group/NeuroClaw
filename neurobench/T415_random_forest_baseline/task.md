# T415_random_forest_baseline: Random Forest Baseline
## Task Description

Train and evaluate the Random Forest Baseline on vectorized FC features for the standard settings. Random forest (500 trees) with feature-importance export.
...
- Use `models/train_unified.py --model random_forest` for both settings.
...
- Save artefacts under `models/benchmark_results/T415_random_forest_baseline/<setting>/`.

- Save checkpoints under `models/checkpoints/random_forest/<atlas>/fold{k}.pt`.
