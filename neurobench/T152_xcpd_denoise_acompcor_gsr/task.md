# T152_xcpd_denoise_acompcor_gsr: XCP-D Denoising: aCompCor+GSR
## Task Description

Post-process fMRIPrep derivatives with XCP-D using the aCompCor + 24 motion parameters + global signal regression strategy. Produce denoised BOLD, confound-filtering QC, and framewise-displacement statistics.
...
- Save all generated artifacts to:
  - benchmark_results/T152_xcpd_denoise_acompcor_gsr/
