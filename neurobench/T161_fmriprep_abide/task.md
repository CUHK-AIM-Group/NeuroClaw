# T161_fmriprep_abide: fMRIPrep Pipeline: ABIDE
## Task Description

Run the full fMRIPrep anatomical + functional workflow for an ABIDE subject (document the site). Produce standard fMRIPrep derivatives and the HTML QC report.
...
- Save all generated artifacts to:
  - benchmark_results/T161_fmriprep_abide/
