# T163_fmriprep_fmapless_syn: fMRIPrep Pipeline: fieldmap-less SyN-SDC
## Task Description

Run the full fMRIPrep anatomical + functional workflow for a subject WITHOUT fieldmaps using `--use-syn-sdc` distortion correction. Produce standard fMRIPrep derivatives and the HTML QC report.
...
- Save all generated artifacts to:
  - benchmark_results/T163_fmriprep_fmapless_syn/
