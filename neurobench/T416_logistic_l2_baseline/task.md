# T416_logistic_l2_baseline: L2 Logistic Regression Baseline
## Task Description

Train and evaluate the L2 Logistic Regression Baseline on vectorized FC features for the standard settings. L2-regularized logistic regression (classification) / ridge (regression).
...
- Use `models/train_unified.py --model logistic_l2` for both settings.
...
- Save artefacts under `models/benchmark_results/T416_logistic_l2_baseline/<setting>/`.

- Save checkpoints under `models/checkpoints/logistic_l2/<atlas>/fold{k}.pt`.
