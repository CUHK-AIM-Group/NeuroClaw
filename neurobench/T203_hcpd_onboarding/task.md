# T203_hcpd_onboarding: HCP-D Onboarding: Download, Stage, Validate
## Task Description

Download a subject subset of HCP Development (HCP-D (Lifespan Development) via ConnectomeDB/NDA), stage it into a BIDS-compliant directory, and produce a validation + inventory report.
...
- Save all generated artifacts to:
  - benchmark_results/T203_hcpd_onboarding/
