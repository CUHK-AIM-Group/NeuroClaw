# T418_kernel_ridge_baseline: Kernel Ridge Baseline
## Task Description

Train and evaluate the Kernel Ridge Baseline on vectorized FC features for the standard settings. Kernel ridge regression (RBF) for the regression setting.
...
- Use `models/train_unified.py --model kernel_ridge` for both settings.
...
- Save artefacts under `models/benchmark_results/T418_kernel_ridge_baseline/<setting>/`.

- Save checkpoints under `models/checkpoints/kernel_ridge/<atlas>/fold{k}.pt`.
