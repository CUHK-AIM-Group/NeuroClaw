...
- **[2026.05.06]**：新增 19 个数据集和模态技能及配套脚本；全部 85 个技能统一元数据格式（`layer`、`skill_type`、`dependencies`）；skill_loader DAG 验证确保依赖图无环。
...
│
├── skills/                         # 85 个技能：base (38) / subagent (41) / interface (6)
│   ├── abide-skill/
│   ├── aibl-skill/
│   ├── abcd-skill/
